/*
 * $RCSfile: AddTimeSlipHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:32 $ - $Author: mking_cv $
 * 
 ...
 */
public final class AddTimeSlipHandler extends Action
{
    ...
    throws IOException, ServletException, CommunicationException,NamingException
  {
    ...
    {
      System.out.println("[Exception] AddTimeSlipHandler.execute: " + e.toString());
    }
    ...
    {
      clearForm((TimeSlipForm) form, mapping);
      returnStatus = ".view.projects.new.timeslip";
    }
    return (mapping.findForward(returnStatus));
  }

  public void clearForm(TimeSlipForm timeSlipForm, ActionMapping mapping)
  {
    timeSlipForm.setProjectID("");
    timeSlipForm.setProject("");
    timeSlipForm.setTicket("");
    timeSlipForm.setTimeSlipID("");
    timeSlipForm.setYear("");
    timeSlipForm.setMonth("");
    timeSlipForm.setDay("");
    timeSlipForm.setTask("");
    timeSlipForm.setStartTime("");
    timeSlipForm.setEndTime("");
    timeSlipForm.setDescription("");
    timeSlipForm.setBreakHours("");
    timeSlipForm.setBreakMinutes("");
  }
}
