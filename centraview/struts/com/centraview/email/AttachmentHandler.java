/*
 * $RCSfile: AttachmentHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:48 $ - $Author: mking_cv $
 * 
...
/**
 * This class does attachment file transfer work
 *
 * @author CentraView, LLC.
 */
public class AttachmentHandler extends Action
{
    ...
    throws Exception
  {
    ...
    try
    {
          ...
          && (request.getParameter("From").equals("Local")))
      {
        ...
        int hmsize = hm.size();
        hm.put(Integer.toString(xxx), strf);
