/*
 * $RCSfile: RuleListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:53 $ - $Author: mking_cv $
 * 
...
public class RuleListElement extends ListElement
{

	private int itsElementID ;

	//constructor
	public RuleListElement( int ID )
	{
		itsElementID = ID;
	}
