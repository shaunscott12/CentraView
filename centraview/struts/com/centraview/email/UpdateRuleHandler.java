/*
 * $RCSfile: UpdateRuleHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:53 $ - $Author: mking_cv $
 * 
 ...
 * @author Vivek T
 */
public final class UpdateRuleHandler extends Action
{
    ...
    throws IOException, ServletException
  {
    ...
    {
      System.out.println("[Exception] UpdateRuleHandler.execute: " + exe.toString());
      forwardTo = "failure";
      //exe.printStackTrace();
    }
