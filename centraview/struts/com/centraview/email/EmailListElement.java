/*
 * $RCSfile: EmailListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:50 $ - $Author: mking_cv $
 * 
...
public class EmailListElement extends ListElement
{

	private int itsElementID ;

	//constructor
	public EmailListElement( int ID )
	{
		itsElementID = ID;
	}
