/*
 * $RCSfile: CustomFieldListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:56 $ - $Author: mking_cv $
 * 
...
public class CustomFieldListElement extends ListElement
{

	private int itsElementID ;

	//constructor
	public CustomFieldListElement( int ID )
	{
		itsElementID = ID;
	}
