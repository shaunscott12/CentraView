/*
 * $RCSfile: EntityListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:00 $ - $Author: mking_cv $
 * 
...
public class EntityListElement extends ListElement
{

	private int itsElementID ;

	public EntityListElement( int ID )
	{
		itsElementID = ID;
	}
