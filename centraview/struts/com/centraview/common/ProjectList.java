/*
 * $RCSfile: ProjectList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:15 $ - $Author: mking_cv $
 * 
...
public class ProjectList extends DisplayList
{
  private String sortMember;
  private String primaryMember;
  private String primaryTable = "project";
  private String PrimaryMemberType = "project.projectid";
  ...
  public ProjectList()
  {
    ...
    columnMap.put("Name", new Integer(70));
    columnMap.put("Entity", new Integer(70));
    columnMap.put("Status", new Integer(50));
    columnMap.put("DueDate", new Integer(50));
  ...
  public void deleteElement(int indvID, String key) throws CommunicationException,NamingException
  {
    ...
    ProjectFacadeHome projectFacadeHome =
      (ProjectFacadeHome) CVUtility.getHomeObject("com.centraview.projects.projectfacade.ProjectFacadeHome",
        "ProjectFacade");
    ...
    try
    {
      ...
      remote.deleteProject(indvID, elementID);
    ...
    {
		logger.error("[Exception] ProjectList.deleteElement( int indvID, String key )", e);
    }
  }
   ...
   public ArrayList deleteElement(int individualID, String recordID[]) throws CommunicationException,NamingException,RemoteException
   {
	   ...
	   try
	   {
		   ...
		   for (int i=0; i<recordID.length; i++)
		   {
			   if(recordID[i] != null && !recordID[i].equals("")){
				   ...
				   try{
				   	remote.deleteProject(individualID, elementID);
				   }//end of try block
	   ...
	   {
		   logger.error("[Exception] ProjectList.deleteElement( int indvID, String rowId[] ) ", e);
  ...
  public void addElement(String ID, ProjectListElement value)
  {
    put(ID, value);
  }
  ...
  public void addProjectElement(ProjectListElement value)
  {
  }

  // get methods
  public void getProjectElement(String value)
  {
  }
