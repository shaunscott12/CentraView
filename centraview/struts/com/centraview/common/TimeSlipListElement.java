/*
 * $RCSfile: TimeSlipListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:18 $ - $Author: mking_cv $
 * 
...
public class TimeSlipListElement extends ListElement
{

	private int itsElementID ;

	//constructor
	public TimeSlipListElement( int ID )
	{
		itsElementID = ID;
	}
