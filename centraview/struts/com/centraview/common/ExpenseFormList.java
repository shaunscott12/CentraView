/*
 * $RCSfile: ExpenseFormList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:00 $ - $Author: mking_cv $
 * 
...
/**
 * ExpensesList Functionality related to TimeSheet List.
 */
public class ExpenseFormList extends DisplayList
{
	private String sortMember ;
	private String primaryMember ;

	private String primaryTable = "expenseform";
	private String PrimaryMemberType = "expensesform.ExpenseFormID";
	...
	private static Logger logger = Logger.getLogger(ExpenseFormList.class);

	// constructor
	public  ExpenseFormList( )
	{
		...
		columnMap.put( "Amount" , new Integer(130) );
		columnMap.put( "Status" , new Integer(130) );
	...
	public void  deleteElement( int indvID, String key ) throws CommunicationException,NamingException
	{
		...
		{
			logger.error("[Exception] ExpenseFormList.deleteElement( int indvID, String key )", e);
		}
	...
	public ArrayList deleteElement(int individualID, String recordID[]) throws CommunicationException,NamingException,RemoteException
	{
		...
		{
			logger.error("[Exception] ExpenseFormList.deleteElement( int indvID, String rowId[] ) ", e);
	...
	public void addElement( String  ID , ExpensesListElement value )
	{
		put( ID , value );
	}
