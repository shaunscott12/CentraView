/*
 * $RCSfile: FolderLookupHandler.java,v $    $Revision: 1.3 $  $Date: 2005/09/07 19:38:08 $ - $Author: mcallist $
 * 
...
public class FolderLookupHandler extends org.apache.struts.action.Action {
  private static Logger logger = Logger.getLogger(FolderLookupHandler.class);
