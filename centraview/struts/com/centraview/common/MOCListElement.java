/*
 * $RCSfile: MOCListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:13 $ - $Author: mking_cv $
 * 
...
public class MOCListElement extends ListElement
{

	private int itsElementID ;

	//constructor
	public MOCListElement( int ID )
	{
		itsElementID = ID;
	}
