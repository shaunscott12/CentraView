/*
 * $RCSfile: ExpensesListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:00 $ - $Author: mking_cv $
 * 
...
public class ExpensesListElement extends ListElement
{

	private int itsElementID ;

	//constructor
	public ExpensesListElement( int ID )
	{
		itsElementID = ID;
	}
