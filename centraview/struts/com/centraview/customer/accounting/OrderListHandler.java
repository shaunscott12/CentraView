/*
 * $RCSfile: OrderListHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:08 $ - $Author: mcallist $
 * 
...
public class OrderListHandler extends Action
{
  private static Logger logger = Logger.getLogger(OrderListHandler.class);
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws ServletException
  {
    String dataSource = Settings.getInstance().getSiteInfo(CVUtility.getHostName(super.getServlet().getServletContext())).getDataSource();
    String forward = ".view.customer.order_list";
    ...
    try {
      ListPreference listPrefs = userObject.getListPreference("Order");
      ValueListParameters listParameters = ActionUtil.valueListParametersSetUp(listPrefs, request, ValueListConstants.CUSTOMER_ORDER_LIST_TYPE, ValueListConstants.customerOrderViewMap, false);
      String filter = "SELECT cvorder.orderid FROM cvorder WHERE entityid=" + entityID;
