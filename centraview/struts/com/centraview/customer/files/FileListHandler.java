/*
 * $RCSfile: FileListHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:09 $ - $Author: mcallist $
 * 
...
{
  private static Logger logger = Logger.getLogger(FileListHandler.class);
