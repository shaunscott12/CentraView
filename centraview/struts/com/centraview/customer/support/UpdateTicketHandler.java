/*
 * $RCSfile: UpdateTicketHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:29 $ - $Author: mking_cv $
 * 
...
public class UpdateTicketHandler extends org.apache.struts.action.Action
{

  final String GLOBAL_FORWARD_failure = "failure";
  final String FORWARD_editsavefile = ".view.customer.ticket_list";
