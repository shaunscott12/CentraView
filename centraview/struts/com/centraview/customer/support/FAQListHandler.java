/*
 * $RCSfile: FAQListHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:08 $ - $Author: mcallist $
 * 
...
public class FAQListHandler extends Action
{
  private static Logger logger = Logger.getLogger(FAQListHandler.class);
