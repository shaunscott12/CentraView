/*
 * $RCSfile: ShowLoginHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:27:27 $ - $Author: mking_cv $
 * 
...
public class ShowLoginHandler extends org.apache.struts.action.Action
{
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws RuntimeException, Exception
  {
    ...
    return mapping.findForward(".view.customer.login");
  }
