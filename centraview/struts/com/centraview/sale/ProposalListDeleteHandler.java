/*
 * $RCSfile: ProposalListDeleteHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:35:56 $ - $Author: mcallist $
 * 
...
/**
 * Delete handler for Proposal list.
 * Created: Sep 13, 2004
 * 
 * @author CentraView, LLC. 
 */
public class ProposalListDeleteHandler extends Action
{
  private static Logger logger = Logger.getLogger(ProposalListDeleteHandler.class);
