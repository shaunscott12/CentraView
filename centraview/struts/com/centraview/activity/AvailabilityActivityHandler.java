/*
 * $RCSfile: AvailabilityActivityHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 21:57:04 $ - $Author: mcallist $
 * 
...
public class AvailabilityActivityHandler extends org.apache.struts.action.Action {
  private static Logger logger = Logger.getLogger(AvailabilityActivityHandler.class);
  
  public static final String GLOBAL_FORWARD_failure = ".view.error";
  private static final String FORWARD_availability = ".view.activities.availability";
      ...
      HttpServletResponse response) throws Exception
  {
    try {
      ...
      // if type of activity is appointment
      ...
      } else if (request.getParameter(ConstantKeys.TYPEOFACTIVITY)
          .equals(ConstantKeys.FORECASTSALE)) {
        request.setAttribute("actionName", "title.contact.forecastsale");
      } else if (request.getParameter(ConstantKeys.TYPEOFACTIVITY).equals(
          ConstantKeys.LITERATUREREQUEST)) {
        request.setAttribute("actionName", "title.contact.literaturerequest");
      ...
      FORWARD_final = FORWARD_availability;
      request.setAttribute(ConstantKeys.TYPEOFSUBACTIVITY, ConstantKeys.AVAILABILITY);
