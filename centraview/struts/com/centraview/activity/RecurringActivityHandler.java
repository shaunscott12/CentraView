/*
 * $RCSfile: RecurringActivityHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 21:57:04 $ - $Author: mcallist $
 * 
...
public class RecurringActivityHandler extends org.apache.struts.action.Action {
  private static Logger logger = Logger.getLogger(RecurringActivityHandler.class);
  public static final String GLOBAL_FORWARD_failure = ".view.error";
  private static final String FORWARD_recurring = ".view.activities.recurring";
      ...
      HttpServletResponse response) throws Exception
  {
    try {
      ...
      form = populateForm.getForm(request, form, ConstantKeys.RECURRING);
      ...
      request.setAttribute(ConstantKeys.TYPEOFSUBACTIVITY, ConstantKeys.RECURRING);
      ...
      FORWARD_final = FORWARD_recurring;
    } catch (Exception e) {
