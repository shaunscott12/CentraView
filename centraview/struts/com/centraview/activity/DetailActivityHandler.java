/*
 * $RCSfile: DetailActivityHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 21:57:04 $ - $Author: mcallist $
 * 
...
public class DetailActivityHandler extends org.apache.struts.action.Action {
  public static final String GLOBAL_FORWARD_failure = ".view.error";
  private static final String FORWARD_detail = ".view.activities.details";
