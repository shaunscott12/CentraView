/*
 * $RCSfile: GarbageListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:40 $ - $Author: mking_cv $
 * 
 ...
 */
/**
 * GarbageListElement.java
 *
 * @version 	1.0 Date  2003/5/12
 * @author Amit Gandhe
 */
...
/**
This class stores all columns for each row of GarbageList

*/

public class GarbageListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public GarbageListElement( int ID ) {
		itsElementID = ID;
	}
