/*
 * $RCSfile: SecurityProfileListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:36 $ - $Author: mking_cv $
 * 
 ...
 */
/**
 * SecurityProfileListElement.java
 *
 * @version 	1.0 Date  2 nd Dec 2003
 * @author Pravin Kadam
 */
...
public class SecurityProfileListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public SecurityProfileListElement( int ID ) {
		itsElementID = ID;
	}
