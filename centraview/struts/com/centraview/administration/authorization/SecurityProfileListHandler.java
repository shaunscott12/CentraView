/*
 * $RCSfile: SecurityProfileListHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:36 $ - $Author: mking_cv $
 * 
...
public class SecurityProfileListHandler extends org.apache.struts.action.Action
{
  private static Logger logger = Logger.getLogger(SecurityProfileListHandler.class);
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    return mapping.findForward(".view.administration.security_profile_list");
  }
}
