/*
 * $RCSfile: CustomViewListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:39 $ - $Author: mking_cv $
 * 
 ...
 */
/**
 * CustomViewListElement.java
 *
 * @version 	1.0 Date  2003/1/12
 * @author Amit Gandhe
 */
...
/**
This class stores all columns for each row of CustomView

*/

public class CustomViewListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public CustomViewListElement( int ID ) {
		itsElementID = ID;
	}
