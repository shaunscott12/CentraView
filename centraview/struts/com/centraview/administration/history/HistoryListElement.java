/*
 * $RCSfile: HistoryListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:42 $ - $Author: mking_cv $
 * 
 ...
 */
/**
 * HistoryListElement.java
 *
 * @version 	1.0 Date  
 * Created on 11 th Dec 2003
 * @author Pravin Kadam
 */
...
public class HistoryListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public HistoryListElement( int ID ) {
		itsElementID = ID;
	}
