/*
 * $RCSfile: AtticList.java,v $    $Revision: 1.2 $  $Date: 2005/09/01 15:31:05 $ - $Author: mcallist $
 * 
...
/**
 * This class is for storing the AtticList List
 * 
 * @author Amit Gandhe
 */
public class AtticList extends DisplayList
{
	private static Logger logger = Logger.getLogger(AtticList.class);
	...
	public AtticList() {
		...
		columnMap.put("AtticID", new Integer(15));
	...
	public ArrayList deleteElement(int individualID, String recordID[])throws CommunicationException,NamingException,RemoteException
	{
		...
		{
			logger.error("[Exception] AtticList.deleteElement( int indvID, String rowId[] )", e);
