/*
 * $RCSfile: AtticListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:40 $ - $Author: mking_cv $
 * 
...
/**
This class stores all columns for each row of AtticList

*/

public class AtticListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public AtticListElement( int ID ) {
		itsElementID = ID;
	}
