/*
 * $RCSfile: LiteratureListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:46 $ - $Author: mking_cv $
 * 
 ...
 */
/**
 * LiateratureListElement.java
 *
 * @version  1.0   
 * Created on   29 th Dec 2003
 * @author Pravin Kadam
 */
...
/**
 * This class stores all columns for each row of Security Profile
 * 	 
 */

public class LiteratureListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public LiteratureListElement( int ID ) {
		itsElementID = ID;
	}
