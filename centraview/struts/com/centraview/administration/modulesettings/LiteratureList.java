/*
 * $RCSfile: LiteratureList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:46 $ - $Author: mking_cv $
 * 
...
public class LiteratureList extends DisplayList
{

	private String sortMember ;
	private String primaryMember ;
	private String primaryTable ="literature";
	private String PrimaryMemberType="LiteratureID";
	...
	public LiteratureList() {
		...
		columnMap.put("LiteratureID", new Integer(15));
		columnMap.put("Title", new Integer(15));
		columnMap.put("File", new Integer(15));
		
		this.setPrimaryMember("LiteratureID");	
