/*
 * $RCSfile: NewThreadHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:52 $ - $Author: mking_cv $
 * 
 ...
 */
public class NewThreadHandler extends Action
{
  public static final String GLOBAL_FORWARD_failure = ".view.error";
  private static final String FORWARD_savenewthread = ".view.support.new_thread";
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
  {
    ...
    try {
      ...
      System.out.println("[Exception] NewThreadHandler.execute: " + e.toString());
