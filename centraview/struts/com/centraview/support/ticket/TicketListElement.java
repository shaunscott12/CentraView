/*
 * $RCSfile: TicketListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:55 $ - $Author: mking_cv $
 * 
 ...
 */
/**
 * TicketListElement.java
 *
 * @version 	1.0 Date  2003/20/8
 * @author Amit Gandhe
 */
...
public class TicketListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public TicketListElement( int ID ) {
		itsElementID = ID;
	}
