/*
 * $RCSfile: KnowledgeBaseDeleteHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:09 $ - $Author: mcallist $
 * 
...
/**
 * Delete handler for KB entries.
 * Created: Oct 25, 2004
 * 
 * @author CentraView, LLC. 
 */
public class KnowledgeBaseDeleteHandler extends Action {
  private static Logger logger = Logger.getLogger(KnowledgeBaseDeleteHandler.class);
