/*
 * $RCSfile: QuestionListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:48 $ - $Author: mking_cv $
 * 
...
public class QuestionListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public QuestionListElement( int ID ) {
		itsElementID = ID;
	}
