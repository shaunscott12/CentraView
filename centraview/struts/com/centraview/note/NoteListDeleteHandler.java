/*
 * $RCSfile: NoteListDeleteHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:10 $ - $Author: mcallist $
 * 
 ...
 */
public class NoteListDeleteHandler extends Action {
  private static Logger logger = Logger.getLogger(NoteListDeleteHandler.class);
  public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException, CommunicationException, NamingException
  {
    ...
    try
    {
      Note ejb = (Note)CVUtility.setupEJB("Note", "com.centraview.note.NoteHome", dataSource);
      for (int i=0; i<rowId.length; i++)
      {
        ...
        {          
          ...
          try
          {
            ejb.deleteNote(individualId, elementId);
