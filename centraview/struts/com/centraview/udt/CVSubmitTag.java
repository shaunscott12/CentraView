/*
 * $RCSfile: CVSubmitTag.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:29:05 $ - $Author: mking_cv $
 * 
...
*/
public class CVSubmitTag extends SubmitTag
{
	private static Logger logger = Logger.getLogger(CVSubmitTag.class);
	...
	*/
	public int doEndTag() throws JspException
	{
		...
		if (label == null && super.text != null){
			label = super.text;
		}// end of if (label == null && super.text != null)

		if (label == null || label.trim().length() < 1){
			label = "Cancel";
		}// end of if (label == null || label.trim().length() < 1)
