...
/**
 * Delete handler for groups. Created: Sep 8, 2004
 * @author CentraView, LLC.
 */
public class GroupListDeleteHandler extends Action {
  private static Logger logger = Logger.getLogger(GroupListDeleteHandler.class);
