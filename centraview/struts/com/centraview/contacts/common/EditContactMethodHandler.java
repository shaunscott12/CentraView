...
import com.centraview.contact.helper.MethodOfContactVOX;
import com.centraview.settings.Settings;

public final class EditContactMethodHandler extends Action {
  private static Logger logger = Logger.getLogger(EditContactMethodHandler.class);
      ...
      NamingException
  {
    ...
    request.setAttribute("listFor", request.getParameter("listFor"));
      ...
      throws CommunicationException, NamingException
  {
    ...
    com.centraview.contact.helper.MethodOfContactVOX mocVOX = new MethodOfContactVOX(form);
    com.centraview.contact.helper.MethodOfContactVO moc = mocVOX.getVO();
