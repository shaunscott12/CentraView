...
/**
 * Delete handler for Related Info contact methods. Created: Dec 3, 2004
 * @author CentraView, LLC.
 */
public class DeleteContactMethodsHandler extends Action {
  private static Logger logger = Logger.getLogger(DeleteContactMethodsHandler.class);
      ...
      NamingException
  {
    ...
    return mapping.findForward(".forward.contacts.related_contact_methods");
  }
}
