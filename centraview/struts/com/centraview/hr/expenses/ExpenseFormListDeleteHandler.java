/*
 * $RCSfile: ExpenseFormListDeleteHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:10 $ - $Author: mcallist $
 * 
...
/**
 * Deletes expense forms.
 * Created: Nov 1, 2004
 * 
 * @author CentraView, LLC. 
 */
public class ExpenseFormListDeleteHandler extends Action {
  private static Logger logger = Logger.getLogger(ExpenseFormListDeleteHandler.class);
  public ActionForward execute(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) throws IOException, ServletException, CommunicationException, NamingException
  {
    ...
    if(returnPath == null){
    	returnPath = mapping.findForward(".view.hr.expenseform.list").getPath();
    }
