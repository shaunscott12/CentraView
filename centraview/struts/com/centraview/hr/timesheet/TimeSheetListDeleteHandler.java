/*
 * $RCSfile: TimeSheetListDeleteHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:09 $ - $Author: mcallist $
 * 
...
/**
 * Delete time sheet list items.
 * Created: Nov 1, 2004
 * 
 * @author CentraView, LLC. 
 */
public class TimeSheetListDeleteHandler extends Action {
  private static Logger logger = Logger.getLogger(TimeSheetListDeleteHandler.class);
