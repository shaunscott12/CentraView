/*
 * $RCSfile: FileListDeleteHandler.java,v $    $Revision: 1.3 $  $Date: 2005/09/07 19:38:09 $ - $Author: mcallist $
 * 
...
/**
 * File list delete action.
 * Created: Oct 28, 2004
 * 
 * @author CentraView, LLC. 
 */
public class FileListDeleteHandler extends Action {
  private static Logger logger = Logger.getLogger(FileListDeleteHandler.class);
	     ...
	     for (int i=0; i<rowId.length; i++) {
	        if(rowId[i] != null && !rowId[i].equals("")) {
	          ...
	          if (elements != null && elements.length == 2){
	        	  if(elements[1] != null && elements[0] != null){
		        	  if (elements[1].equals("FOLDER"))
		        		  fileFacade.deleteFolder(individualId, Integer.parseInt(elements[0]), dataSource);
		        	  else if (elements[1].equals("FILE"))
		        		  fileFacade.deleteFile(individualId, Integer.parseInt(elements[0]), dataSource);
	        	  }
	          }
	          else if(typeOfFile != null && typeOfFile.equals("FILE"))
