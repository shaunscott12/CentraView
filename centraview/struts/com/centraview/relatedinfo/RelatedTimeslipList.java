/*
 * $RCSfile: RelatedTimeslipList.java,v $    $Revision: 1.2 $  $Date: 2005/06/02 15:14:35 $ - $Author: mking_cv $
 * 
 ...
 * screens where the listType is "Task". The class will generate
 ...
 */
public class RelatedTimeslipList extends org.apache.struts.action.Action
{
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    String viewType = "Timeslip";
    ...
    String filter = "SELECT timeSlipId FROM timeslip WHERE projectId = " + recordID;
    // Buttons
    ...
    RelatedInfoUtil.relatedInfoSetup(request, dataSource, viewType, ValueListConstants.TIMESLIPS_LIST_TYPE, ValueListConstants.timeslipsViewMap, filter.toString(), buttonList, 0);
