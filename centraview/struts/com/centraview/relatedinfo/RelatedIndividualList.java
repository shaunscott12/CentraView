/*
 * $RCSfile: RelatedIndividualList.java,v $    $Revision: 1.2 $  $Date: 2005/06/10 17:52:31 $ - $Author: mking_cv $
 * 
 ...
 * screens where the listType is "Individual". The class will generate
 ...
 *
 */
public class RelatedIndividualList extends org.apache.struts.action.Action
{
  private static Logger logger = Logger.getLogger(RelatedIndividualList.class);
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    filter.append("SELECT individual.individualId FROM individual WHERE individual.entity = "); 
    ...
    RelatedInfoUtil.relatedInfoSetup(request, dataSource, viewType, ValueListConstants.BOTTOM_INDIVIDUAL_LIST_TYPE, ValueListConstants.individualViewMap, filter.toString(), buttonList, 0);
