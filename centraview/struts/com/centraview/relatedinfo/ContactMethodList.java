/*
 * $RCSfile: ContactMethodList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:34 $ - $Author: mking_cv $
 * 
 ...
 * where the listType is "Address". The class will generate the proper
 * DisplayList and set a request attribute. Control will then transfer to the
 * View layer.
 */
public class ContactMethodList extends org.apache.struts.action.Action
{
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    String filter = "SELECT moc.mocid FROM methodofcontact AS moc, mocrelate AS mr WHERE mr.mocid = moc.mocid AND mr.contacttype = " + contactType + " AND mr.contactId = " + recordID;
    // Buttons
    ...
    RelatedInfoUtil.relatedInfoSetup(request, dataSource, viewType, ValueListConstants.MOC_LIST_TYPE, ValueListConstants.mocViewMap, filter.toString(), buttonList, 0);
