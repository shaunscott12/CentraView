/*
 * $RCSfile: RelatedPaymentList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:36 $ - $Author: mking_cv $
 * 
 ...
 * screens where the listType is "Payment". The class will generate
 * the proper DisplayList and set a request attribute. Control will then
 * transfer to the View layer.
 */
public class RelatedPaymentList extends Action
{
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    String viewType = "Payment";
    ...
    // Filter
    // This is only called for Entity
    String filter = "SELECT paymentId FROM payment WHERE EntityID = " + recordID;
    // Buttons
    ...
    RelatedInfoUtil.relatedInfoSetup(request, dataSource, viewType, ValueListConstants.PAYMENT_LIST_TYPE, ValueListConstants.paymentViewMap, filter.toString(), buttonList, 0);
