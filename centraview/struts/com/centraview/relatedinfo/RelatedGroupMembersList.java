/*
 * $RCSfile: RelatedGroupMembersList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:35 $ - $Author: mking_cv $
 * 
 ...
 * screens where the listType is "GroupMember". The class will generate
 * the proper DisplayList and set a request attribute. Control will then
 * transfer to the View layer.
 */
public class RelatedGroupMembersList extends Action
{
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    String viewType = "GroupMember";
    ...
    filter.append("SELECT individual.individualId FROM individual, opportunity AS opp, member AS gm ");
    filter.append("WHERE individual.individualId = gm.childId AND gm.groupId = opp.accountTeam AND opp.opportunityId = ");
...
} // end of RelatedGroupMembersList class
