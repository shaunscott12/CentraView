/*
 * $RCSfile: RelatedTaskList.java,v $    $Revision: 1.2 $  $Date: 2005/06/02 15:14:35 $ - $Author: mking_cv $
 * 
 ...
 */
public class RelatedTaskList extends org.apache.struts.action.Action
{
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    String filter = "SELECT activityId FROM task WHERE projectId = " + recordID;
    // Buttons
    ...
    RelatedInfoUtil.relatedInfoSetup(request, dataSource, viewType, ValueListConstants.TASKS_LIST_TYPE, ValueListConstants.tasksViewMap, filter.toString(), buttonList, 0);
