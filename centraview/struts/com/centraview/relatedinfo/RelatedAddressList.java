/*
 * $RCSfile: RelatedAddressList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:35 $ - $Author: mking_cv $
 * 
 ...
 */
public class RelatedAddressList extends org.apache.struts.action.Action
{
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    String dataSource = Settings.getInstance().getSiteInfo(CVUtility.getHostName(super.getServlet().getServletContext())).getDataSource();
    String viewType = "Address";
    ...
    String filter = "SELECT address AS addressId FROM addressrelate WHERE contactType = " + contactType + " AND contact = " + recordID;
    // Buttons
    ...
    RelatedInfoUtil.relatedInfoSetup(request, dataSource, viewType, ValueListConstants.ADDRESS_LIST_TYPE, ValueListConstants.addressViewMap, filter.toString(), buttonList, 0);
