/*
 * $RCSfile: AccountingLines.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:11 $ - $Author: mking_cv $
 * 
...
abstract public class AccountingLines extends TreeMap
{
	...
	abstract public void addLine (AccountingLineElement ale);
	abstract public void removeLine (int lineID);
	abstract public void removeLine (int[] lineID);
