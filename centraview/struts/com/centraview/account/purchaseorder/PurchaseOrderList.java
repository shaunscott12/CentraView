/*
 * $RCSfile: PurchaseOrderList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:25 $ - $Author: mking_cv $
 * 
...
/**
 * PurchaseOrderList.java
 * @version 	1.0 Date  2003/09/15
 * @author Shilpa Patil
 */
...
/*
This class is for storing the PurchaseOrder List 
*/

public class PurchaseOrderList extends DisplayList
{

	private String sortMember ;
	private String primaryMember ;
	private String primaryTable ="purchaseorder";
	private String PrimaryMemberType="PurchaseOrderID";
	...
	private static Logger logger = Logger.getLogger(PurchaseOrderList.class);
	...
	public PurchaseOrderList()
	{
		...
		columnMap.put("Tax",new Integer(50));
		columnMap.put("Total",new Integer(50));
		columnMap.put("Status",new Integer(50));
		
		this.setPrimaryMember("PurchaseOrderID");	
	 ...
	 * @param   value  
	 */
	public void addPurchaseOrderElement(PurchaseOrderListElement value )
	{
	}
	 ...
	 * @param   String  
	 */
	public void getPurchaseOrderElement( String value )
	{
	}
