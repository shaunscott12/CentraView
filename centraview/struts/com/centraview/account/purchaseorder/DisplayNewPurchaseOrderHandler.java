/*
 * $RCSfile: DisplayNewPurchaseOrderHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:24 $ - $Author: mking_cv $
 * 
...
public class DisplayNewPurchaseOrderHandler extends org.apache.struts.action.Action
{
	...
	// Local Forwards
	private static final String FORWARD_newpurchase = ".view.accounting.purchaseorder.new";
	private static String FORWARD_final = GLOBAL_FORWARD_failure;
	private static Logger logger = Logger.getLogger(DisplayNewPurchaseOrderHandler.class);
    ...
    String dataSource = Settings.getInstance().getSiteInfo(CVUtility.getHostName(super.getServlet().getServletContext())).getDataSource();
		...
		{
			logger.error("[Exception] DisplayNewPurchaseOrderHandler.Execute Handler ", e);
