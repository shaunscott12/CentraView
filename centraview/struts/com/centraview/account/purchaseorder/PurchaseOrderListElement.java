/*
 * $RCSfile: PurchaseOrderListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:25 $ - $Author: mking_cv $
 * 
...
/**
This class stores all columns for each row of expense

*/

public class PurchaseOrderListElement extends ListElement
{
	 ...
	 * @param   ID
	 */
	public PurchaseOrderListElement( int ID )
	{
		itsElementID = ID;
	}
