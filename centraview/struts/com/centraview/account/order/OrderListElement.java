/*
 * $RCSfile: OrderListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:22 $ - $Author: mking_cv $
 * 
...
/**
This class stores all columns for each row of Item

*/

public class OrderListElement extends ListElement
{
	 ...
	 * @param   ID
	 */
	public OrderListElement( int ID )
	{
		itsElementID = ID;
	}
