/*
 * $RCSfile: OrderList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:22 $ - $Author: mking_cv $
 * 
...
/**
 * OrderList.java
 * @version 	1.0 Date  28 Augaust 2003
...
public class OrderList extends DisplayList
{

	private String sortMember ;
	private String primaryMember ;
	private String primaryTable ="cvorder";
	private String PrimaryMemberType="orderid";
	...
	private static Logger logger = Logger.getLogger(OrderList.class);
	...
	public OrderList()
	{
		...
		columnMap.put("OrderID",new Integer(25));
		columnMap.put("OrderNO",new Integer(25));
		columnMap.put("Entity",new Integer(50));
		columnMap.put("Date",new Integer(50));
		columnMap.put("Total",new Integer(50));
		columnMap.put("SalesRep",new Integer(50));
		columnMap.put("Status",new Integer(50));
		columnMap.put("Discount",new Integer(50));
		columnMap.put("Creator",new Integer(50));
		columnMap.put("PONumber",new Integer(50));

		columnMap.put("EntityID",new Integer(50));
		columnMap.put("SalesRepID",new Integer(50));
		
		this.setPrimaryMember("OrderNO");	
	...
	public ArrayList deleteElement(int individualID, String recordID[]) throws CommunicationException,NamingException,RemoteException
	{
		...
		{
			logger.error("[Exception] OrderList.deleteElement( int indvID, String rowId[] ) ", ce);
