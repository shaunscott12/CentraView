/*
 * $RCSfile: GLAccountListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:14 $ - $Author: mking_cv $
 * 
...
/**
This class stores all columns for each row of GLAccounts

*/

public class GLAccountListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public GLAccountListElement( int ID )
	{
		itsElementID = ID;
	}
