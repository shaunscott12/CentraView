/*
 * $RCSfile: ExpenseList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:13 $ - $Author: mking_cv $
 * 
...
/**
 * This class is for storing the expense List.
 *
 * @author Shilpa Patil
 */
public class ExpenseList extends DisplayList
{

	private String sortMember ;
	private String primaryMember ;
	private String primaryTable ="expense";
	private String PrimaryMemberType="ExpenseID";
	...
	private static Logger logger = Logger.getLogger(ExpenseList.class);
	...
	public ExpenseList()
	{
		...
		this.setPrimaryMember("ExpenseID");
	}
	 ...
	 * @param   value
	 */
	public void addExpenseElement( ExpenseListElement value )
	{
	}
	 ...
	 * @param   String
	 */
	public void getExpenseElement( String value )
	{
	}
	...
	public ArrayList deleteElement(int individualID, String recordID[]) throws CommunicationException,NamingException,RemoteException
	{
		...
		{
			logger.error("[Exception] ExpenseList.deleteElement( int indvID, String rowId[] ) ", ce);
