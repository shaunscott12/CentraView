/*
 * $RCSfile: NewExpenseHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:14 $ - $Author: mking_cv $
 * 
...
public class NewExpenseHandler  extends org.apache.struts.action.Action
{
	// Global Forwards
	public static final String GLOBAL_FORWARD_failure = "failure";

	// Local Forwards
	private static final String FORWARD_newexpense = ".view.accounting.expenses.new";
	private static String FORWARD_final = GLOBAL_FORWARD_failure;
	static int counter = 0;

	private static Logger logger = Logger.getLogger(NewExpenseHandler.class);
	  ...
	  String dataSource = Settings.getInstance().getSiteInfo(CVUtility.getHostName(super.getServlet().getServletContext())).getDataSource();
		...
		try
		{
			...
			*/
			...
			// forward to jsp page
			FORWARD_final = FORWARD_newexpense;

		} catch (Exception e)
		{
			logger.error("[Exception] NewExpenseHandler.Execute Handler ", e);
