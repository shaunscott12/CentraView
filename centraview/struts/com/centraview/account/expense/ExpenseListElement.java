/*
 * $RCSfile: ExpenseListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:13 $ - $Author: mking_cv $
 * 
...
public class ExpenseListElement extends ListElement
{
	 ...
	 * @param   ID
	 */
	public ExpenseListElement( int ID )
	{
		itsElementID = ID;
	}
