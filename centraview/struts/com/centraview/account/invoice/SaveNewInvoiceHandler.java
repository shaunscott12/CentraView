/*
 * $RCSfile: SaveNewInvoiceHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:18 $ - $Author: mking_cv $
 * 
...
public class SaveNewInvoiceHandler  extends org.apache.struts.action.Action
{
	...
	private static Logger logger = Logger.getLogger(SaveNewInvoiceHandler.class);
		...
		throws IOException, ServletException, CommunicationException, NamingException
	{
	  String dataSource = Settings.getInstance().getSiteInfo(CVUtility.getHostName(super.getServlet().getServletContext())).getDataSource();
		...
		{
			logger.error("[Exception] SaveNewInvoiceHandler.Execute Handler ", e);
