/*
 * $RCSfile: InvoiceListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:17 $ - $Author: mking_cv $
 * 
...
/**
This class stores all columns for each row of Invoice

*/

public class InvoiceListElement extends ListElement
{
	 ...
	 * @param   ID
	 */
	public InvoiceListElement( int ID )
	{
		itsElementID = ID;
	}
