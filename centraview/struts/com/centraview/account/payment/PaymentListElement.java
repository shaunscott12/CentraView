/*
 * $RCSfile: PaymentListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:23 $ - $Author: mking_cv $
 * 
...
/**
This class stores all columns for each row of Payment

*/

public class PaymentListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public PaymentListElement( int ID )
	{
		itsElementID = ID;
	}
