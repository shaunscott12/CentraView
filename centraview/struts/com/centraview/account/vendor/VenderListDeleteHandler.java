/*
 * $RCSfile: VenderListDeleteHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:09 $ - $Author: mcallist $
 * 
 ...
 */
public class VenderListDeleteHandler extends Action
{
  private static Logger logger = Logger.getLogger(VenderListDeleteHandler.class);
    ...
    try
    {
      ...
      for (int i=0; i<rowId.length; i++)
      {
        if(rowId[i] != null && !rowId[i].equals(""))
        {
          ...
          try
          {
			remote.deleteVendor(elementID,individualId);
