/*
 * $RCSfile: DisplayInventoryHandler.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:14 $ - $Author: mking_cv $
 * 
...
public class DisplayInventoryHandler  extends org.apache.struts.action.Action
 {
    ...
    String dataSource = Settings.getInstance().getSiteInfo(CVUtility.getHostName(super.getServlet().getServletContext())).getDataSource();
		...
		try
		{
			...
			int invID = Integer.parseInt(rowId);
			...
			invenForm.setQty(inventoryVO.getQty());
			//To set all IDs to int value
			invenForm.convertFormbeanToValueObject();
							
			invenForm.setInventoryID(invID);
			invenForm.setFormType("edit");
		...
		{
			System.out.println("[Exception][DisplayInventoryHandler.execute] Exception Thrown: "+e);
			e.printStackTrace();
