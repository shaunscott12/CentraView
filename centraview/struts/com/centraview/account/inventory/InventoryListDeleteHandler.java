/*
 * $RCSfile: InventoryListDeleteHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:38:11 $ - $Author: mcallist $
 * 
 ...
 */
public class InventoryListDeleteHandler extends Action
{
  private static Logger logger = Logger.getLogger(InventoryListDeleteHandler.class);
        ...
        if(rowId[i] != null && !rowId[i].equals(""))
        {
          ...
          try
          {
            ...
            logger.error("[execute] Exception thrown.", re);
          	...
          	logger.error("[execute] Exception thrown.", ie);
          }
