/*
 * $RCSfile: InventoryListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:26:16 $ - $Author: mking_cv $
 * 
...
/**
This class stores all columns for each row of Inventory

*/

public class InventoryListElement extends ListElement
{
	 ...
	 * @param   ID  
	 */
	public InventoryListElement( int ID )
	{
		itsElementID = ID;
	}
