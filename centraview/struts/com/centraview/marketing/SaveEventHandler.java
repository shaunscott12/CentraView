/*
 * $RCSfile: SaveEventHandler.java,v $    $Revision: 1.2 $  $Date: 2005/10/17 17:11:42 $ - $Author: mcallist $
 * 
...
public class SaveEventHandler extends Action {
  ...
  private static Logger logger = Logger.getLogger(SaveEventHandler.class);
