/*
 * $RCSfile: ListManagerDeleteHandler.java,v $    $Revision: 1.2 $  $Date: 2005/09/07 19:36:00 $ - $Author: mcallist $
 * 
...
/**
 * Delete handler for Marketing Lists. 
 * Created: Oct 21, 2004
 * 
 * @author CentraView, LLC. 
 */
public class ListManagerDeleteHandler extends Action {
  private static Logger logger = Logger.getLogger(ListManagerDeleteHandler.class);
