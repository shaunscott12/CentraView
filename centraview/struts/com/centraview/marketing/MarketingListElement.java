/*
 * $RCSfile: MarketingListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:15 $ - $Author: mking_cv $
 * 
...
public class MarketingListElement extends ListElement
{

	private int itsElementID ;

	//constructor
	public MarketingListElement( int ID )
	{
		itsElementID = ID;
	}
