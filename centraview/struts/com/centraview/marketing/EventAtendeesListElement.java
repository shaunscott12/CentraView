/*
 * $RCSfile: EventAtendeesListElement.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:12 $ - $Author: mking_cv $
 * 
...
public class EventAtendeesListElement extends ListElement
{

	private int itsElementID ;

	//constructor
	public EventAtendeesListElement( int ID )
	{
		itsElementID = ID;
	}
