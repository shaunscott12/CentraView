/*
 * $RCSfile: EventList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:12 $ - $Author: mking_cv $
 * 
 ...
 * @author Linesh
 */
public class EventList extends DisplayList
{

	private String sortMember ;
	private String primaryMember ;
	private String primaryTable = "event";
	private String PrimaryMemberType = "eventid";
	...
	public  EventList()
	{
		...
		columnMap.put( "end" , 					new Integer(100) );
		columnMap.put( "registeredattendees" , 	new Integer(180) ) ;
	...
	public void  deleteElement( int indvID, String key ) throws CommunicationException,NamingException
	{
		...
		try
		{
			...
			remote.deleteEvent(elementID);
			// TODO deleteEvent user-rights.
		}
		catch( Exception e )
		{
			logger.error("[Exception] EventList.deleteElement( int indvID, String key )", e);
		}
	}
