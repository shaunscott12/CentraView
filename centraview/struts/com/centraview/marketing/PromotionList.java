/*
 * $RCSfile: PromotionList.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:28:18 $ - $Author: mking_cv $
 * 
...
*/
public class PromotionList extends DisplayList
{

	private String sortMember ;
	private String primaryMember ;
	private String primaryTable = "promotion";
	private String PrimaryMemberType = "promotionid";
	...
	private static Logger logger = Logger.getLogger(PromotionList.class);
	...
	public  PromotionList()
	{
		...
		columnMap.put( "promotionid" , 			new Integer(100) );
		columnMap.put( "title" , 				new Integer(120) );
		columnMap.put( "detail" , 				new Integer(120) ) ;
		columnMap.put( "start" , 				new Integer(100) );
		columnMap.put( "end" , 					new Integer(120) );
		columnMap.put( "registeredattendees" , 	new Integer(120) ) ;
		columnMap.put( "ownername" , 			new Integer(120) ) ;
		this.setPrimaryMember("promotionid");
	}
	...
	public ArrayList deleteElement(int individualID, String recordID[]) throws CommunicationException,NamingException,RemoteException
	{
		...
		{
			logger.error("[Exception] PromotionList.deleteElement( int indvID, String rowId[] ) ", e);
