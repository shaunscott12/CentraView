...
// This widget config is used in email - not everything, but pretty close
FCKConfig.ToolbarSets["cvDefault"] = [
	['Cut','Copy','Paste','SelectAll','-','Print','SpellCheck','-','Undo','Redo','-','Find','Replace','RemoveFormat','SpecialChar','-','Source','Preview','-','About'],
  '/',
	['Style','FontFormat','FontName','FontSize'],
  '/',
	['Bold','Italic','Underline','StrikeThrough','-','TextColor','BGColor','-','OrderedList','UnorderedList','Outdent','Indent','-','JustifyLeft','JustifyCenter','JustifyRight','-','Link','Unlink','-','Image','Table','Rule','Smiley']
] ;

// This widget config is used in activity details
FCKConfig.ToolbarSets["cvActivity"] = [
	['Style','FontFormat','FontName','FontSize'],
  '/',
	['Bold','Italic','Underline','StrikeThrough','-','TextColor','BGColor','-','OrderedList','UnorderedList','Outdent','Indent','-','JustifyLeft','JustifyCenter','JustifyRight','-','Link','Unlink','-','Image','Table','Rule','Smiley']
] ;
