<%--
 * $RCSfile: login_nav_tabs.jsp,v $    $Revision: 1.2 $  $Date: 2005/08/10 13:31:41 $ - $Author: mcallist $
 *
    ...
    <td class="tabsContainerTopRow">
      <table border="0" cellspacing="0" cellpadding="0" class="tabsTable">
        <tr>
          ...
          <td class="tabsOn"><html:link action="/customer_login.do" styleClass="tabsOn"><bean:message key="label.customer.tiles.login"/></html:link></td>
