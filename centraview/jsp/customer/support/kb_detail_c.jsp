<%--
 * $RCSfile: kb_detail_c.jsp,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:25:24 $ - $Author: mking_cv $
 * 
...
<tiles:insert page="/jsp/customer/templates/main_template.jsp" flush="true" >
  ...
  <tiles:put name="body" value="/jsp/customer/support/kb_detail.jsp" />
  <tiles:put name="footer" value="/jsp/customer/common/footer.jsp" /> 
</tiles:insert>
<app:TitleWindow moduleName="Support: Knowledgebase: Details" />
