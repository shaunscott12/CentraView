<%--
* $RCSfile: new_promotion.jsp,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:25:54 $ - $Author: mking_cv $
* 
...
<!--
  ...
  function setItem(itemLookupValues)
  {
    ...
    if(flag)
    {
      document.promotionlistform.action = "<html:rewrite page='/marketing/new_promotion.do'/>?<%=AccountConstantKeys.TYPEOFOPERATION%>=<%=AccountConstantKeys.ADDITEM%>";
    }
    else
    {
      document.promotionlistform.action = "<html:rewrite page='/marketing/new_promotion.do'/>?<%=AccountConstantKeys.TYPEOFOPERATION%>=<%=AccountConstantKeys.REMOVEITEM%>";
    }
  ...
  */
  ...
  function gotosave(forwardto){
    var id = document.promotionlistform.promotionid.value;
    document.promotionlistform.action="<html:rewrite page='/marketing/save_promotion.do'/>?closeornew="+forwardto+"&operation=Add&promotionid="+id;
    document.promotionlistform.submit();
  }
...
<html:form action="/marketing/save_promotion">
        ...
        <tr>
          ...
          <td valign="top" align="left" width="50%">
            <table width="100%" border="0" cellpadding="0">
              ...
              <tr>
                <td>
                  <jsp:include page="custom_field.jsp"> 
  ...
  <tr>
    <td align="left" class="sectionHeader">
         <html:button property="saveclose" styleClass="normalButton" onclick="saveRecord('close' ,'Add')">
           <bean:message key="label.saveandclose"/>
         </html:button>            
         <html:button property="savenew" styleClass="normalButton" onclick="saveRecord('new','Add')">
