<%--
 * $RCSfile: new_kb_category.jsp,v $ $Revision: 1.2 $ $Date: 2005/08/10 13:31:40 $ - $Author: mcallist $
 *
...
<html:form action="/support/save_category.do">
<html:errors/>
...
function checkAddEditCategory(closeornew)	{
	window.document.forms[0].action="<bean:message key='label.url.root' />/support/save_category.do?closeornew="+closeornew+"&Button=yes";
