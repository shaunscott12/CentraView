<%--
 * $RCSfile: new_knowledgebase.jsp,v $ $Revision: 1.2 $ $Date: 2005/08/10 13:31:40 $ - $Author: mcallist $
 *
...
<html:form action="/support/save_knowledgebase.do">
<html:errors/>
...
function addEditKB(closeornew)	{
	window.document.forms[0].action="<bean:message key='label.url.root' />/support/save_knowledgebase.do?closeornew="+closeornew;
