<%
/**
 * $RCSfile: new_timeslip.jsp,v $    $Revision: 1.2 $  $Date: 2005/08/10 13:31:40 $ - $Author: mcallist $
 *
...
<html:form action="/projects/save_new_timeslip">
<table border="0" cellspacing="0" cellpadding="0" width="100%">
      ...
      <table cellspacing="0" cellpadding="3">
        ...
        <tr>
          ...
          <td class="contentCell">
            ...
            <app:cvbutton property="LookupButton" styleClass="normalButton" onclick="fnLookup()" disabled="false"><bean:message key='label.value.lookup'/>
            </app:cvbutton>
        </td>
        </tr>
        ...
        <tr>
          ...
          <td class="contentCell">
            ...
            <app:cvbutton property="TaskLookupButton" styleClass="normalButton" onclick="fnTask()" disabled="false"><bean:message key='label.value.lookup'/>
            </app:cvbutton>
        ...
        <tr>
          ...
          <td class="contentCell"><html:textarea property="description" cols="42" rows="5" styleClass="inputBox"></html:textarea></td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td class="sectionHeader" colspan="2" align="left">
      <app:cvsubmit property="saveandclose" styleClass="normalButton" statuswindow="label.saveandclose" tooltip="false" statuswindowarg= "New TimeSlip" >
...
<app:TitleWindow moduleName="<bean:message key='label.modulename.projectsnewtimeslip'/>"/>
</html:form>