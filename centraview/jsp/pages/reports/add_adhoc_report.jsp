<%--
 * $RCSfile: add_adhoc_report.jsp,v $ $Revision: 1.4 $ $Date: 2005/08/10 13:31:42 $ - $Author: mcallist $
 *
...
<%
    ...
    int noOfSearches = searches.size();
...
<html:form action="/reports/new_adhoc.do" styleId="reportForm">
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><table border="0" cellspacing="0" cellpadding="0" width="100%">
                  <tr height="17">
                    <td colspan="2" class="sectionHeader"><bean:message key="label.reports.adhocreport"/></td>
                  </tr>
                </table></td>
                <td width="11"><html:img page="/images/spacer.gif" height="1" width="11" /></td>
              </tr>
                  ...
                  <tr>
                    <td class="contentCell">
       			  <select name="topFields" size="10" class="inputBox" style="width:15em;">
                          <option>-- <bean:message key="label.reports.selecttable"/>--</option>
                      </select>
                    </td>
                    <td width="5"><html:img page="/images/spacer.gif" height="1" width="5" /></td>
                    <td class="labelCell">
                    ...
                    <td valign="top" class="contentCell">
                      ...
                      for (i = 0; i < sortIds.length; i++)
                      {
                              ...
                              min = max;
                      %>
                      <option value="<%=sortOrder[curi]%><%=fieldTableIds[curi]%>:<%=fieldIds[curi]%>"><%=fieldNames[curi]%>
                      <%
                      }
                      %>
                      </select><br><br>
			...
			<td colspan="3" height="100%"><html:img page="/images/spacer.gif" height="11" width="11" /></td>
              ...
              <tr>
                ...
                <td align="right">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
    		      <td><app:cvbutton property="savenclose" styleClass="normalButton" statuswindow="label.general.blank" tooltip="true" statuswindowarg= "label.general.blank" onclick="return checkAddReport('close');">
      			<bean:message key="label.saveandclose"/>
      			</app:cvbutton>
                      </td>
                      <td width="13"><html:img page="/images/spacer.gif" width="13" height="1" /></td>
      		      <td><app:cvbutton property="savennew" styleClass="normalButton"  style="width:8em;" statuswindow="label.general.blank" tooltip="true" statuswindowarg= "label.general.blank" onclick="return checkAddReport('new');">
      			<bean:message key="label.saveandnew"/>
       			</app:cvbutton>
                      </td>
                      <td width="13"><html:img page="/images/spacer.gif" width="13" height="1" /></td>
      		      <td><app:cvbutton property="savennew" styleClass="normalButton"  style="width:8em;" statuswindow="label.general.blank" tooltip="true" statuswindowarg= "label.general.blank" onclick="return checkAddReport('run');">
...
<!--
	...
	{
    var reportForm = document.getElementById("reportForm");
		reportForm.createNew.value = "false";
		reportForm.addRow.value = "true";
		submitForm();
	}
    ...
    reportForm.createNew.value = "false";
		reportForm.removeRow.value = rowIndex;
		submitForm();
	}
    ...
    var reportForm = document.getElementById("reportForm");
    reportForm.createNew.value = "false";
		reportForm.saveSearch.value = "true";
		submitForm();
	}
    ...
    var reportForm = document.getElementById("reportForm");
    reportForm.createNew.value = "false";
		reportForm.applySearch.value = "true";
		saveSearchAction();
	}
	...
	{
		reportForm.deleteSearch.value = "true";
		submitForm();
	}
  ...
  function checkAddReport(action)
  {
    saveContent();
    var reportForm = document.getElementById("reportForm");
    reportForm.action="<html:rewrite page="/reports/add_adhoc.do"/>?action="+action;
    reportForm.submit();
    return false;
  }
//-->
