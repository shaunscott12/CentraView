<%--
 * $RCSfile: main_email_t.jsp,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:25:28 $ - $Author: mking_cv $
 * 
...
<table border="0" cellspacing="0" cellpadding="0" class="mainContentTable" height="80%">
  <tr valign="top">
