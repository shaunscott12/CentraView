<%--
 * $RCSfile: errorPage.jsp,v $    $Revision: 1.2 $  $Date: 2005/08/10 13:31:50 $ - $Author: mcallist $
 *
...
<html:html>
<head>
<title>CentraView: <bean:message key="label.jsp.error"/></title>
</head>
<body>
<h2><bean:message key="label.jsp.applicationerror"/></h2>
<%-- Error Messages --%>
