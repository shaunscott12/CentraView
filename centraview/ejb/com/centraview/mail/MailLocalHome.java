/*
 * $RCSfile: MailLocalHome.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:22:36 $ - $Author: mking_cv $
 * 
...
public interface MailLocalHome extends EJBLocalHome
{
   ...
   * 
   */
  public MailLocal create() throws CreateException;
} //end of MailLocalHome interface