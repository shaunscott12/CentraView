/*
 * $RCSfile: AdditionalMenu.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:21:38 $ - $Author: mking_cv $
 * 
...
public interface AdditionalMenu extends EJBObject
{
	public Vector getAllAdditionalMenuItems(boolean isOrdered) throws RemoteException;	
	/**
