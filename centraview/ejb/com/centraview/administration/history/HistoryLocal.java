/*
 * $RCSfile: HistoryLocal.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:21:45 $ - $Author: mking_cv $
 * 
...
public interface HistoryLocal extends EJBLocalObject {

	//----------------------------------------------- Methods

	/**
	 * This method checks whether RecordID
	 *
