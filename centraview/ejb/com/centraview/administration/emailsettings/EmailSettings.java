/*
 * $RCSfile: EmailSettings.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:21:43 $ - $Author: mking_cv $
 * 
 ...
 */
public interface EmailSettings extends EJBObject
{
	/**
	...
	*/
  public void updateEmailSettings(EmailSettingsVO emailSettingVO) throws RemoteException;
   ...
   * username, password, smtpserver, etc...
   */
  public EmailSettingsVO getEmailSettings() throws RemoteException;
   ...
   *
   */
  public void updateEmailTemplate(EmailTemplateForm emailTemplateFrom) throws RemoteException;
   ...
   * @return emailTemplateFrom the EmailTemplateForm Object according to the template Selected by user.
	 *
   */
  public EmailTemplateForm getEmailTemplate(int emailTemplateID) throws RemoteException;
   ...
   */
  public boolean simpleMessage(int individualID, MailMessageVO mailMessageVO) throws SendFailedException, NamingException, CreateException,MessagingException,RemoteException;
