/*
 * $RCSfile: TimeSheet.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:22:27 $ - $Author: mking_cv $
 * 
...
public interface TimeSheet extends EJBObject
{
  public int addTimeSheet(int userId, TimeSheetVO tsvo) throws RemoteException,AuthorizationFailedException;
	...
	public int updateTimeSheet(int individualId, TimeSheetVO tsvo) throws RemoteException,AuthorizationFailedException;
