/*
 * $RCSfile: InventoryLocal.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:21:27 $ - $Author: mking_cv $
 * 
...
public interface InventoryLocal extends EJBLocalObject
{
  ...
  public InventoryVO getInventory(int individualID, int itemId) throws InventoryException, AuthorizationFailedException;
  ...
  public void deleteInventory(int individualID, int itemId) throws InventoryException, AuthorizationFailedException;
  /**
