/*
 * $RCSfile: AccountFacadeHome.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:21:20 $ - $Author: mking_cv $
 * 
...
public interface AccountFacadeHome extends EJBHome
{
     ...
     */
    public AccountFacade create() throws CreateException , RemoteException  ;
}