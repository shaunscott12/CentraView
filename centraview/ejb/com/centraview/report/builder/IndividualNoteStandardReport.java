 ...
 * @author mcallist
 */
public class IndividualNoteStandardReport extends ReportBuilder {
  /**
   * @param ds
   * @throws Exception
   */
  public IndividualNoteStandardReport(String ds) throws Exception {
    super(ds);
   ...
   * @throws Exception
   */
  public IndividualNoteStandardReport(Date dateFrom, Date dateTo, String ds, String whereClause) throws Exception {
