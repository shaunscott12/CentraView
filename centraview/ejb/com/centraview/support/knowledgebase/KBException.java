/*
 * $RCSfile: KBException.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:23:10 $ - $Author: mking_cv $
 * 
...
public class KBException extends Exception
{
	...
	public static final int ADD_TO_CHILD = 6;
	 ...
	 */
	public KBException(int exceptionId,String exceptionDescription)
	{
		super();
	...
	{
		String errMsg = "com.centraview.support.knowledgebase.KBException : " + this.exceptionId 
