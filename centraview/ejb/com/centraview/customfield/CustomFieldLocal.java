/*
 * $RCSfile: CustomFieldLocal.java,v $    $Revision: 1.3 $  $Date: 2005/05/24 20:19:40 $ - $Author: mking_cv $
 * 
...
public interface CustomFieldLocal extends EJBLocalObject
{
  ...
  public void addCustomField(CustomFieldVO cfdata);
  ...
  public CustomFieldList getCustomFieldList(int userID, HashMap hm);
  public HashMap getCustomFieldValue();
  public void addNewCustomField(CustomFieldVO cfData);
