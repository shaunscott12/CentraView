/*
 * $RCSfile: EmailManage.java,v $    $Revision: 1.1.1.1 $  $Date: 2005/04/28 20:22:14 $ - $Author: mking_cv $
 * 
...
public interface EmailManage extends EJBObject
{
    public int emailMoveTo(int sourceId , int destId,String mailIdList[]) throws RemoteException,Exception;
    public int emailDelete(int sourceId , int destId,String mailIdList[]) throws RemoteException,Exception;
	public int emailDeleteTrash(int trashfolderid,String mailIdList[])throws RemoteException,Exception;
